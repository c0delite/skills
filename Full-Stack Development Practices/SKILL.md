...
**NOT for:**
- Pure frontend/UI concerns (use Next.js Best Practices Skill)
- Pure database schema design without backend context (use Supabase Postgres Best Practices Skill)
